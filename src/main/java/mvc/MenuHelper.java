...
public class MenuHelper {
    ...
    public static void initColorMenu(View view, JMenuBar menuBar) {
        ...
        addMenuItem(colorMenu, new StyledEditorKit.ForegroundAction("Pale blue", Color.cyan));
    ...
    public static void initStyleMenu(View view, JMenuBar menuBar) {
        ...
        addMenuItem(styleMenu, "Highlighted", new StyledEditorKit.UnderlineAction());
        addMenuItem(styleMenu, "Cursive", new StyledEditorKit.ItalicAction());
    ...
    public static void initEditMenu(View view, JMenuBar menuBar) {
        ...
        JMenuItem redoItem = addMenuItem(editMenu, "Substitute ", new RedoAction(view));
